      ...
      <div className="max-w-2xl mb-8">
        <div className="relative">
          ...
          <Input
            ...
            className="pl-12 h-12 bg-white/10 border-none text-white placeholder:text-gray-400"
          />
        </div>
      </div>
        ...
        <div className="space-y-8">
          ...
          {results.tracks?.items[0] && (
            <section>
              ...
              <div
                className="bg-white/5 hover:bg-white/10 rounded-lg p-6 cursor-pointer transition max-w-md"
              ...
              >
                ...
                />
                <h3 className="text-3xl font-bold mb-2">{results.tracks.items[0].name}</h3>
                <p className="text-sm text-gray-400">{results.tracks.items[0].artists.map((a) => a.name).join(", ")}</p>
              </div>
            </section>
          )}
